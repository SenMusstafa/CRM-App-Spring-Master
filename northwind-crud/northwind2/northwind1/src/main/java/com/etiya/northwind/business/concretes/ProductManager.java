...
public class ProductManager implements ProductService {
    ...
    private final CategoryService.ProductRepository productRepository;
    private final ModelMapperService modelMapperService;

    public ProductManager(CategoryService.ProductRepository productRepository, ModelMapperService modelMapperService) {
